    ...
    <section className="py-14 sm:py-16 bg-[var(--th-surface-alt)] border-b border-[var(--th-border)]">
      <div className="max-w-[1480px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12">
          ...
          <h2 className="font-serif text-3xl sm:text-4xl font-bold text-[var(--th-text-main)] tracking-wide uppercase">
                ...
                <div className="relative aspect-square overflow-hidden bg-[var(--th-pedestal)]">
                  ...
                  <div className="absolute top-3 left-3 z-10 flex flex-col gap-1">
                    {product.isBestSeller && (
                      <span className="bg-[var(--th-primary)] text-white text-[9px] font-extrabold px-2 py-0.5 rounded-full uppercase tracking-wider shadow-sm border border-white/20">
                        Bestseller
                      </span>
                    )}
                    {discountPercent > 0 && (
                      <span className="bg-[var(--th-accent)] text-white text-[9px] font-extrabold px-2 py-0.5 rounded-full uppercase tracking-wider shadow-xs">
                  ...
                  <div>
                    <div className="flex items-center justify-between text-[11px] text-[var(--th-text-muted)] mb-1">
                      ...
                      <div className="flex items-center space-x-1 text-[var(--th-accent)] shrink-0">
                        ...
                        <span className="text-[10px] text-[var(--th-text-muted)]">({product.reviewsCount || 28})</span>
                      </div>
                    </div>
        ...
        <div className="mt-12 text-center">
          <button
            ...
            className="px-8 py-3.5 rounded-full border-2 border-[var(--th-primary)] text-[var(--th-primary)] font-serif text-xs font-bold tracking-widest uppercase hover:bg-[var(--th-primary)] hover:text-white transition-all duration-300 inline-flex items-center space-x-2.5 shadow-sm hover:shadow-lg cursor-pointer"
          >
