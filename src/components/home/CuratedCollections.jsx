    ...
    <section className="py-14 sm:py-16 bg-[#DFD4C0] border-b border-[#C5B299]">
      <div className="max-w-[1480px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12">
          <div className="flex items-center justify-center space-x-2 text-[#9A650C] mb-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
          {COLLECTIONS.map((col) => (
            <div
              ...
              className="group relative h-[360px] sm:h-[400px] rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl border-2 border-[#C5B299] hover:border-[#9A650C] transition-all duration-500 cursor-pointer flex flex-col justify-end p-6 sm:p-7"
            >
              {/* Background Image */}
              <img
                src={col.image}
              ...
              <div className="absolute top-6 left-6 z-10">
                <span className="bg-[#0B2545] text-[#F8E6C8] text-[10px] font-extrabold uppercase tracking-widest px-3.5 py-1.5 rounded-full shadow-md border border-[#D4AF37]/40">
                  {col.tag}
                </span>
              </div>
              ...
              <div className="relative z-10 text-white flex flex-col items-start">
                ...
                <p className="text-xs sm:text-sm text-[#EAE2D5] font-sans mb-5 line-clamp-2">
                  {col.subtitle}
                </p>
