    ...
    <section className="py-14 sm:py-16 bg-[#FAF5EB] border-b border-[#DFCBB5]">
      <div className="max-w-[1480px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 relative h-[360px] sm:h-[400px] rounded-3xl overflow-hidden border-2 border-[#DFCBB5] hover:border-[#AA820A] shadow-xl group transition-all duration-500">
            <img
            ...
            <div className="absolute inset-x-6 bottom-6 sm:inset-x-8 sm:bottom-8 text-white z-10">
              <span className="bg-[#4A0711] text-[#F3E5AB] text-[10px] font-bold uppercase tracking-widest px-3 py-1 rounded-full mb-2 inline-block border border-[#D4AF37]/30">
                LIFELONG KEEPSAKE
              </span>
              ...
              <p className="text-xs sm:text-sm text-[#DFCBB5] max-w-lg mb-4 font-sans">
              ...
              <button
                ...
                className="px-6 py-2.5 rounded-full bg-gradient-to-r from-[#D4AF37] to-[#AA820A] text-[#1A1A1A] font-serif text-xs font-bold tracking-widest uppercase hover:from-[#E6CA65] hover:to-[#D4AF37] transition-all duration-300 inline-flex items-center space-x-2 cursor-pointer shadow-md"
              >
          ...
          <div className="lg:col-span-5 flex flex-col justify-between space-y-6">
            <div className="bg-[#FFFDF9] rounded-3xl p-6 sm:p-8 border border-[#DFCBB5] shadow-md hover:border-[#AA820A] transition-all">
              <h3 className="font-serif text-xl sm:text-2xl font-bold text-[#4A0711] mb-4">
              ...
              <div className="space-y-4">
                {HIGHLIGHTS.map((item, idx) => (
                  <div key={idx} className="flex items-start space-x-3.5">
                    ...
                    <div>
                      <h4 className="font-bold text-xs sm:text-sm text-[#301D17]">
                        {item.title}
                      </h4>
                      <p className="text-xs text-[#7A5844] mt-0.5 leading-relaxed">
                        {item.desc}
                      </p>
                    </div>
                  </div>
              ...
              <div className="mt-8 pt-6 border-t border-[#F0E6D6] flex flex-wrap items-center gap-3">
                <button
                  onClick={() => onNavigateCategory && onNavigateCategory('silver-coins-bars')}
                  className="flex-1 py-3 bg-[#4A0711] text-[#F3E5AB] font-serif text-xs font-bold tracking-widest uppercase rounded-xl hover:bg-[#600814] transition-colors text-center cursor-pointer shadow-sm border border-[#D4AF37]/30"
                >
                  Buy 999 Bullion
                </button>
                <button
                  onClick={onNavigateYatraCustomizer}
                  className="px-5 py-3 border-2 border-[#AA820A] text-[#4A0711] font-serif text-xs font-bold tracking-wider uppercase rounded-xl hover:bg-[#FAF5EB] transition-colors cursor-pointer"
                >
                  Custom Photo Gifts
                </button>
              </div>
